...
urlpatterns = [
    ...
    path('api/ai/ollama-chat/', ollama_chat, name='ollama_chat'),
    path('api/ai/ollama-stream/', ollama_stream, name='ollama_stream'),
    path('api/ai/deepseek-chat/', deepseek_chat, name='deepseek_chat'),
    path('api/ai/deepseek-stream/', deepseek_stream, name='deepseek_stream'),
